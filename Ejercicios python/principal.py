# ===============================
# SISTEMA DE PUBLICACIONES - UML
# ===============================

# ---------- Clase EDITORIAL (única) ----------
class Editorial:
...
if __name__ == "__main__":
    ...
    libro1 = Libro(
        "Los mejores jugadores de futbol de cada país",
        "L001",
        "Análisis de los jugadores de futbol más destacados de cada nación.",
        52000,
        editorial_unica,
        "Rodolfo Hernández",
        "Deporte"
    ...
    hilo1 = Hilo("Foro de Deportes", "Los mejores jugadores de futbol de cada país")
